...
| Cooking yield | 0.75 (range 0.65–0.75) | cooked → raw meat | Central value: [USDA ARS, Table of Cooking Yields for Meat and Poultry](https://www.ars.usda.gov/ARSUserFiles/80400525/data/retn/usda_cookingyields_meatpoultry.pdf). Range: USDA SR28 paired weights per lb ready-to-cook chicken, items 05006/05009 (276 g raw, 178 g roasted, meat and skin: 0.65) and 05011/05013 (197 g raw, 146 g roasted, meat only: 0.74) | Range verified from the SR28 files; 0.75 is the high (conservative) end |
...
| Definition of dressing percentage | — | wording | [University of Maine Extension, Understanding Poultry Yields](https://extension.umaine.edu/publications/2223e/) | Verified |
...
| Ready-to-cook basis (open question) | 61% | possible correction to the edible share | SR28 item 05006: 1 lb ready-to-cook chicken yields 276 g raw meat and skin (61%). The 68% refuse figure excludes neck and giblets; if the dressing figure includes them, meat per bird is about 12% lower than used and harms 12% higher | Unresolved; the current choice leans toward less harm |
