...
| Cooking yield | 0.75 (range 0.70–0.80) | cooked → raw meat | [USDA ARS, Table of Cooking Yields for Meat and Poultry](https://www.ars.usda.gov/ARSUserFiles/80400525/data/retn/usda_cookingyields_meatpoultry.pdf) | Central value from the table; the range is approximate and not yet checked line by line |
