...
var TEXT = {
  ...
  equation: {
    ...
    notesBasis: 'One open question on the weight side: SR28 also says that one pound of ready-to-cook chicken yields 276 g of raw meat and skin, which is 61%, not the 68% the refuse figure gives. The gap is the neck and giblets, which come with a ready-to-cook bird but are not carcass meat. If the 72–75% dressing figure counts them, as US ready-to-cook yields usually do, one bird yields about 1,120 g of meat rather than 1,250 g and every figure on this site is about 12% too low. The choice made here leans the conservative way, toward less harm.',
